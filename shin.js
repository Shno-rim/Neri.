...
case 'sendbug':
    ...
    if (!isOwner) return  reply('_bot sedang maintenance_')
...
case 'shop':
if (!isOwner) return  reply('_bot sedang maintenance_')
nero = await getBuffer(`https://telegra.ph/file/9528980ca2725c6a581ba.jpg`)
shopp = `=_=_=_=_=_=_=_=_=_=_=_=_=
*Double XP*
  
  _2× Double XP_ : 20 *gold*
  _4× Double XP_ : 40 *gold*
  _7× Double XP_ : 90 *gold*
  _10× Double XP_ : 120 *gold*
  _15× Double XP_ : 180 *gold*
  _20× Double XP_ : 230 *gold*
  
*Peralatan Petualang*
  
  _Pisau_ : 15 *gold*
  _Busur_ : 37 *gold*
  _Zirah Kulit_ : 130 *gold*
  _Zirah Besi_ : 290 *gold*
  _Pedang Kayu_ : 80 *gold*
  _Tongkat Sihir_ : 150 *gold*
  _Anak Panah 20_ : 90 *gold*
  _Tombak_ : 97 *gold*
...
shino.sendMessage(from, nero, image, { caption: shopp})
break
...
if (isCmd){
teks = `Maaf Bot Sedang Maintenance`
