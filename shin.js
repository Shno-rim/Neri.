...
case prefix+'sendbug':
        ...
        case prefix+'creator':
               ...
               break
      case prefix+'groupshino':
      case prefix+'groupserina':
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/shrturl?url=${q}&apikey=IkyOgiwara`)
					shino.sendMessage(from, `${anu.result}`, text, {quoted: shin})
					break
        case prefix+'imagemani':
case prefix+'imageefek':
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
wibu = `
𝐈𝐌𝐀𝐆𝐄 𝐌𝐀𝐍𝐈𝐏𝐔𝐋𝐀𝐓𝐈𝐎𝐍
...
case prefix+'chiisaihentai':
                ...
                case prefix+'animethighss':
                case prefix+'hentaiparadise':
                case prefix+'animearmpits':
                case prefix+'hentaifemdom':
                case prefix+'lewdanimegirls':
                case prefix+'biganimetiddies':
                case prefix+'animebellybutton':
                case prefix+'hentai4everyone':
					if (isBanned) return reply('Maaf kamu sudah terbenned!')          
   if (!isNsfw) return reply('nsfw belum aktif')
                reply (mess.wait)
      ...
      case prefix+'nsfw_avatar':
       ...
       reply (mess.wait)
              ...
              shino.relayWAMessage(prep)
                ...
                case prefix+'classic':
                case prefix+'erokemo':
                case prefix+'fox_girl':
                case prefix+'lewdkemo':
                case prefix+'waifuu':
                case prefix+'wallpaper':
                case prefix+'pussy_jpg':
...
case prefix+'unblock':
       ...
       case prefix+'gawgura':
             ...
             .then(body => {
              ...
              break
       case prefix+'animestick':
       case prefix+'stickeranime':
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
              reply(mess.wait)
...
//------------------< G R U P >-------------------
 ...
 break
       ...
       case prefix+'tagall':
              ...
              break
       case prefix+'kickall': // Anti Banned
              for (let i of groupMembers) {
...
case prefix+'caripesan':  //by ANU TEAM
